...
$query = "SELECT COUNT(DISTINCT user_id) as total FROM absensi WHERE tanggal BETWEEN ? AND ? AND status = 'selesai'";
$month_working_days = getRow($conn, $query, [$this_month_start, $this_month_end], 'ss')['total'];
...
// All employees
$query = "SELECT id, nama, email, role, status FROM users WHERE role = 'karyawan' ORDER BY nama";
...
<body class="bg-gray-50 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 bg-gradient-to-r from-red-500 to-red-700 rounded-lg flex items-center justify-center">
                ...
                <div class="flex items-center gap-4">
                    <div class="hidden md:flex items-center gap-3 bg-gray-100 px-4 py-2 rounded-full">
                        <div class="w-8 h-8 bg-gradient-to-r from-red-400 to-red-600 rounded-full flex items-center justify-center text-white font-bold text-sm">
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600">Pantau sistem absensi perusahaan</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <div class="glass-card rounded-2xl shadow-lg border-transparent overflow-hidden">
                    <div class="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-6 flex items-center gap-3">
                        <i class="fas fa-list-check text-lg"></i>
                        <div>
                            <h2 class="text-lg font-bold">Absensi Hari Ini</h2>
                            <p class="text-blue-100 text-sm"><?php echo date('l, d F Y'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="p-4 border-t bg-gray-50">
                        <a href="/admin/laporan.php" class="text-blue-600 hover:text-blue-800 text-sm font-semibold flex items-center gap-2">
            ...
            <div class="space-y-6">
                ...
                <div class="glass-card rounded-2xl p-6 shadow-lg border-transparent">
                    <h3 class="text-lg font-bold mb-4 flex items-center gap-2">
                        <i class="fas fa-bars text-red-600"></i> Menu Admin
                    </h3>
                    <div class="space-y-3">
                        <a href="/admin/users.php" class="block p-4 bg-gradient-to-r from-blue-50 to-blue-100 hover:from-blue-100 hover:to-blue-200 rounded-xl transition border border-blue-200">
                            <div class="flex items-center gap-3">
                                <i class="fas fa-user-tie text-blue-600 text-xl"></i>
                                <div>
                                    <p class="font-semibold text-blue-900 text-sm">Kelola User</p>
                                    <p class="text-xs text-blue-700">CRUD Karyawan & HRD</p>
                                </div>
                            </div>
                        </a>
                        <a href="/admin/setting.php" class="block p-4 bg-gradient-to-r from-purple-50 to-purple-100 hover:from-purple-100 hover:to-purple-200 rounded-xl transition border border-purple-200">
                            <div class="flex items-center gap-3">
                                <i class="fas fa-cog text-purple-600 text-xl"></i>
                                <div>
                                    <p class="font-semibold text-purple-900 text-sm">Pengaturan</p>
                                    <p class="text-xs text-purple-700">GPS & Jam Kerja</p>
                                </div>
                            </div>
                        </a>
                        <a href="/admin/laporan.php" class="block p-4 bg-gradient-to-r from-green-50 to-green-100 hover:from-green-100 hover:to-green-200 rounded-xl transition border border-green-200">
                            <div class="flex items-center gap-3">
                                <i class="fas fa-chart-bar text-green-600 text-xl"></i>
                                <div>
                                    <p class="font-semibold text-green-900 text-sm">Laporan</p>
                                    <p class="text-xs text-green-700">Absensi & Gaji</p>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <!-- Info Box -->
                <div class="glass-card rounded-2xl p-6 shadow-lg border-l-4 border-yellow-500 bg-gradient-to-br from-yellow-50 to-yellow-100">
                    <h4 class="font-bold text-yellow-900 mb-3 flex items-center gap-2">
                        <i class="fas fa-info-circle text-yellow-600"></i> Ringkasan
                    </h4>
